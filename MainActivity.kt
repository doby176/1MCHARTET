...
class MainActivity : AppCompatActivity() {
    ...
    private fun getStreetsJSON(): String {
        // TOP 1500 MOST COMMON ISRAELI STREETS - English → Hebrew Translation
        ...
        return """
        {
          "streets": [
            {"en": "Herzl", "he": "הרצל"},
            {"en": "Ben Gurion", "he": "בן גוריון"},
            {"en": "Weizmann", "he": "ויצמן"},
            {"en": "Rothschild", "he": "רוטשילד"},
            {"en": "ROTCHILD", "he": "רוטשילד"},
            {"en": "Rotchild", "he": "רוטשילד"},
            ...
            {"en": "King George", "he": "קינג ג'ורג'"},
            {"en": "Harav Kook", "he": "הרב קוק"},
            {"en": "Ben Yehuda", "he": "בן יהודה"},
            {"en": "Sheinkin", "he": "שינקין"},
            {"en": "Ibn Gabirol", "he": "אבן גבירול"},
            {"en": "Nachalat Binyamin", "he": "נחלת בנימין"},
            {"en": "HaKovesh", "he": "הכובש"},
            {"en": "Yoel Cohen", "he": "יואל כהן"},
            {"en": "Chana Michael Levin", "he": "חנה ומיכאל לוין"},
            {"en": "Machali Halevi", "he": "מחלי הלוי"},
            {"en": "HaTaasia", "he": "התעשייה"},
            {"en": "HaNasi", "he": "הנשיא"},
            {"en": "Jabotinsky", "he": "ז'בוטינסקי"},
            {"en": "Zhabotinsky", "he": "ז'בוטינסקי"},
            {"en": "Harav Maimon", "he": "הרב מימון"},
            {"en": "Sokolov", "he": "סוקולוב"},
            {"en": "Arlozorov", "he": "ארלוזורוב"},
            {"en": "Arlozorow", "he": "ארלוזורוב"},
            {"en": "Nordau", "he": "נורדאו"},
            {"en": "Menachem Begin", "he": "מנחם בגין"},
            {"en": "Begin", "he": "בגין"},
            {"en": "Moshe Sharett", "he": "משה שרת"},
            {"en": "Levi Eshkol", "he": "לוי אשכול"},
            {"en": "Eshkol", "he": "אשכול"},
            {"en": "Golda Meir", "he": "גולדה מאיר"},
            {"en": "Yitzhak Rabin", "he": "יצחק רבין"},
            {"en": "Rabin", "he": "רבין"},
            {"en": "King David", "he": "דוד המלך"},
            {"en": "David HaMelech", "he": "דוד המלך"},
            {"en": "King Solomon", "he": "שלמה המלך"},
            {"en": "Shlomo HaMelech", "he": "שלמה המלך"},
            {"en": "King Saul", "he": "שאול המלך"},
            {"en": "Shaul HaMelech", "he": "שאול המלך"},
            ...
            {"en": "Shmuel", "he": "שמואל"},
            {"en": "Elijah", "he": "אליהו"},
            {"en": "Eliyahu HaNavi", "he": "אליהו הנביא"},
            {"en": "Balfour", "he": "בלפור"},
            {"en": "Bialik", "he": "ביאליק"},
            {"en": "Ahad Haam", "he": "אחד העם"},
            {"en": "Ahad Ha'am", "he": "אחד העם"},
            {"en": "Shimon HaTzadik", "he": "שמעון הצדיק"},
            {"en": "Rambam", "he": "רמב״ם"},
            {"en": "Rashi", "he": "רש״י"},
            {"en": "Ramban", "he": "הרמב״ן"},
            {"en": "Derech Hebron", "he": "דרך חברון"},
            {"en": "Derech Jaffa", "he": "דרך יפו"},
            {"en": "Derech Ben Gurion", "he": "דרך בן גוריון"},
            {"en": "Derech Herzl", "he": "דרך הרצל"},
            {"en": "Derech Shalom", "he": "דרך שלום"},
            {"en": "Derech Yerushalayim", "he": "דרך ירושלים"},
            {"en": "Derech Jerusalem", "he": "דרך ירושלים"},
            {"en": "Derech Heil", "he": "דרך חיל"},
            {"en": "Sderot Rothschild", "he": "שדרות רוטשילד"},
            {"en": "Sderot Yerushalayim", "he": "שדרות ירושלים"},
            {"en": "Sderot Ben Gurion", "he": "שדרות בן גוריון"},
            {"en": "Sderot Herzl", "he": "שדרות הרצל"},
            {"en": "Sderot Weizmann", "he": "שדרות ויצמן"},
            {"en": "Sderot Chen", "he": "שדרות חן"},
            {"en": "Sderot Yehudit", "he": "שדרות יהודית"},
            {"en": "HaRishonim", "he": "הראשונים"},
            {"en": "HaAtzmaut", "he": "העצמאות"},
            {"en": "HaGefen", "he": "הגפן"},
            {"en": "HaZayit", "he": "הזית"},
            {"en": "HaTeena", "he": "התאנה"},
            {"en": "HaRimon", "he": "הרימון"},
            {"en": "HaTamar", "he": "התמר"},
            {"en": "HaAlon", "he": "האלון"},
            {"en": "HaErez", "he": "הארז"},
            {"en": "HaBrosh", "he": "הברוש"},
            {"en": "HaOren", "he": "האורן"},
            {"en": "HaShaked", "he": "השקד"},
            {"en": "HaCharuv", "he": "החרוב"},
            {"en": "HaDekel", "he": "הדקל"},
            {"en": "Einstein", "he": "איינשטיין"},
            {"en": "Bar Kochba", "he": "בר כוכבא"},
            {"en": "Bar Kokhba", "he": "בר כוכבא"},
            {"en": "HaNachal", "he": "הנחל"},
            {"en": "HaGalil", "he": "הגליל"},
            {"en": "Yaakov Dori", "he": "יעקב דורי"},
            {"en": "Eliezer Ben Yehuda", "he": "אליעזר בן יהודה"},
            {"en": "Gordon", "he": "גורדון"},
            {"en": "David Raziel", "he": "דוד רזיאל"},
            {"en": "Derech Eilat", "he": "דרך אילת"},
            {"en": "Derech Begin", "he": "דרך בגין"},
            {"en": "Derech HaDarom", "he": "דרך הדרום"},
            {"en": "Derech HaShalom", "he": "דרך השלום"},
            {"en": "Derech Haifa", "he": "דרך חיפה"},
            {"en": "Derech Lakish", "he": "דרך לכיש"},
            {"en": "Derech Tel Aviv", "he": "דרך תל אביב"},
            {"en": "Derech Holon", "he": "דרך חולון"},
            {"en": "Derech Rishon", "he": "דרך ראשון"},
            {"en": "Derech Rehovot", "he": "דרך רחובות"},
            {"en": "Derech Nes Ziona", "he": "דרך נס ציונה"},
            {"en": "Derech Ramat Gan", "he": "דרך רמת גן"},
            {"en": "HaHagana", "he": "ההגנה"},
            {"en": "HaHistadrut", "he": "ההסתדרות"},
            {"en": "HaPalmach", "he": "הפלמ״ח"},
            {"en": "HaYarkon", "he": "הירקון"},
            {"en": "HaKnesset", "he": "הכנסת"},
            {"en": "HaKarmel", "he": "הכרמל"},
            {"en": "HaNevii'm", "he": "הנביאים"},
            {"en": "HaNevi'im", "he": "הנביאים"},
            {"en": "HaNegev", "he": "הנגב"},
            {"en": "HaSharon", "he": "השרון"},
            {"en": "HaMelacha", "he": "המלאכה"},
            {"en": "HaTidhar", "he": "התדהר"},
            {"en": "HaBonim", "he": "הבונים"},
            {"en": "HaChalutz", "he": "החלוץ"},
            {"en": "HaShomer", "he": "השומר"},
            {"en": "Lincoln", "he": "לינקולן"},
            {"en": "Meir", "he": "מאיר"},
            {"en": "Montefiore", "he": "מונטיפיורי"},
            {"en": "Michael", "he": "מיכאל"},
            {"en": "Masada", "he": "מסדה"},
            {"en": "Moshe Dayan", "he": "משה דיין"},
            {"en": "Dayan", "he": "דיין"},
            {"en": "Nahalat Binyamin", "he": "נחלת בנימין"},
            {"en": "Nahariya", "he": "נהריה"},
            {"en": "Yitzhak Sadeh", "he": "יצחק שדה"},
            {"en": "Yosef Hanasi", "he": "יוסף הנשיא"},
            {"en": "Yoseftal", "he": "יוספטל"},
            {"en": "Keren Kayemet", "he": "קרן קיימת"},
            ...
            {"en": "Yigal Alon", "he": "יגאל אלון"},
            {"en": "Alon", "he": "אלון"},
            {"en": "Brenner", "he": "ברנר"},
            {"en": "Trumpeldor", "he": "טרומפלדור"},
            {"en": "Tchernicho", "he": "טשרניחובסקי"},
            {"en": "Tschernichowsky", "he": "טשרניחובסקי"},
            {"en": "Wolfson", "he": "וולפסון"},
            {"en": "Katznelson", "he": "קצנלסון"},
            {"en": "Katz", "he": "כץ"},
            {"en": "Cohen", "he": "כהן"},
            {"en": "Levi", "he": "לוי"},
            {"en": "Bloch", "he": "בלוך"},
            {"en": "Stricker", "he": "שטריקר"},
            {"en": "Shazar", "he": "שז״ר"},
            {"en": "Yigal Yadin", "he": "יגאל ידין"},
            {"en": "Yadin", "he": "ידין"},
            {"en": "Har Sinai", "he": "הר סיני"},
            {"en": "Har Carmel", "he": "הר כרמל"},
            {"en": "Har Hermon", "he": "הר חרמון"},
            {"en": "Har Tavor", "he": "הר תבור"},
            {"en": "Shvil HaZahav", "he": "שביל הזהב"},
            {"en": "Shvil HaTavor", "he": "שביל התבור"},
            {"en": "Nahal Sorek", "he": "נחל שורק"},
            {"en": "Nahal Ayalon", "he": "נחל איילון"},
            {"en": "Nahal Yarkon", "he": "נחל הירקון"},
            {"en": "Nahal Kishon", "he": "נחל קישון"},
            {"en": "Jabotinski", "he": "ז'בוטינסקי"},
            {"en": "Sirkin", "he": "סירקין"},
            {"en": "HaYovel", "he": "היובל"},
            {"en": "HaGiborim", "he": "הגיבורים"},
            {"en": "HaLohamim", "he": "הלוחמים"},
            {"en": "HaHaganah", "he": "ההגנה"},
            {"en": "HaMaccabi", "he": "המכבי"},
            {"en": "HaMaccabim", "he": "המכבים"},
            {"en": "HaPoral", "he": "הפורל"},
            {"en": "HaShikmim", "he": "השקמים"},
            {"en": "HaRakafot", "he": "הרקפות"},
            {"en": "HaVradim", "he": "הוורדים"},
            {"en": "HaNarkisim", "he": "הנרקיסים"},
            {"en": "HaKala", "he": "הכלה"},
            {"en": "HaSayifim", "he": "הסייפים"},
            {"en": "HaDaganim", "he": "הדגנים"},
            {"en": "HaTmarim", "he": "התמרים"},
            {"en": "HaRimonim", "he": "הרימונים"},
            {"en": "HaTut", "he": "התות"},
            {"en": "HaSela", "he": "הסלע"},
            {"en": "HaGoren", "he": "הגורן"},
            {"en": "HaKeshet", "he": "הקשת"},
            {"en": "HaNitzoz", "he": "הניצוץ"},
            {"en": "HaNesher", "he": "הנשר"},
            {"en": "HaZorem", "he": "הזורם"},
            {"en": "HaTzanhanim", "he": "הצנחנים"},
            {"en": "HaHistoria", "he": "ההיסטוריה"},
            {"en": "HaArazim", "he": "האר זים"},
            {"en": "HaBe'er", "he": "הבאר"},
            {"en": "Sderot Namal", "he": "שדרות נמל"},
            {"en": "Sderot Shel", "he": "שדרות של"},
            {"en": "Menachem Usishkin", "he": "מנחם אוסישקין"},
            {"en": "Usishkin", "he": "אוסישקין"},
            {"en": "Frishman", "he": "פרישמן"},
            {"en": "Frug", "he": "פרוג"},
            {"en": "Pinsker", "he": "פינסקר"},
            {"en": "Lilienblum", "he": "לילינבלום"},
            {"en": "Smolenskin", "he": "סמולנסקין"},
            {"en": "Mapu", "he": "מאפו"},
            {"en": "Mendele", "he": "מנדלי"},
            {"en": "Shalom Aleichem", "he": "שלום עליכם"},
            {"en": "Peretz", "he": "פרץ"},
            {"en": "Shlonsky", "he": "שלונסקי"},
            {"en": "Greenberg", "he": "גרינברג"},
            {"en": "Shenkar", "he": "שנקר"},
            {"en": "Haim Weizmann", "he": "חיים וייצמן"},
            {"en": "Chaim Weizmann", "he": "חיים וייצמן"},
            {"en": "Chaim Nachman Bialik", "he": "חיים נחמן ביאליק"},
            {"en": "Haim Nachman Bialik", "he": "חיים נחמן ביאליק"},
            {"en": "Yitzhak Ben Zvi", "he": "יצחק בן צבי"},
            {"en": "Yosef Hayim Brenner", "he": "יוסף חיים ברנר"},
            {"en": "Shmu'el Yosef Agnon", "he": "שמואל יוסף עגנון"},
            {"en": "Agnon", "he": "עגנון"},
            {"en": "Alterman", "he": "אלתרמן"},
            {"en": "Goldberg", "he": "גולדברג"},
            {"en": "Leah Goldberg", "he": "לאה גולדברג"},
            {"en": "Natan Alterman", "he": "נתן אלתרמן"},
            {"en": "Hanita", "he": "חניתה"},
            {"en": "Negba", "he": "נגבה"},
            ...
            {"en": "Ein Harod", "he": "עין חרוד"},
            {"en": "Sdot Yam", "he": "שדות ים"},
            {"en": "Mishmar HaEmek", "he": "משמר העמק"},
            {"en": "Giv'at Brenner", "he": "גבעת ברנר"},
            {"en": "Kfar Sava", "he": "כפר סבא"},
            ...
            {"en": "Afula", "he": "עפולה"},
            {"en": "Yokne'am", "he": "יקנעם"},
            {"en": "Or Akiva", "he": "אור עקיבא"},
            {"en": "Zichron Ya'akov", "he": "זכרון יעקב"},
            {"en": "Zichron Yaakov", "he": "זכרון יעקב"},
            {"en": "Binyamina", "he": "בנימינה"},
            {"en": "Pardes Hanna", "he": "פרדס חנה"},
            {"en": "Caesarea", "he": "קיסריה"},
            {"en": "Hadera", "he": "חדרה"},
            {"en": "Beit She'an", "he": "בית שאן"},
            {"en": "Shoham", "he": "שוהם"},
            {"en": "Modi'in", "he": "מודיעין"},
            ...
            {"en": "Givat Shmueli", "he": "גבעת שמואל"},
            {"en": "Bat Yam", "he": "בת ים"},
            {"en": "Azur", "he": "אזור"},
            {"en": "Azor", "he": "אזור"},
            {"en": "Ramot Gan", "he": "רמות גן"},
            {"en": "Ganei Aviv", "he": "גני אביב"},
            {"en": "Nahal Alexander", "he": "נחל אלכסנדר"},
            {"en": "Nahal Lakhish", "he": "נחל לכיש"},
            {"en": "Nahal Besor", "he": "נחל בשור"},
            {"en": "Nahal Hadera", "he": "נחל חדרה"},
            {"en": "Beit Dagan", "he": "בית דגן"},
            {"en": "Yehud", "he": "יהוד"},
            {"en": "Yehud Monosson", "he": "יהוד מונוסון"},
            {"en": "Nof Yam", "he": "נוף ים"},
            ...
            {"en": "Kiryat Haim", "he": "קרית חיים"},
            {"en": "Tirat Carmel", "he": "טירת כרמל"},
            {"en": "Atlit", "he": "עתלית"},
            {"en": "Jisr az-Zarqa", "he": "גשר א-זרקא"},
            {"en": "Fureidis", "he": "פוריידיס"},
            {"en": "Daliyat al-Karmel", "he": "דלית אל-כרמל"},
            {"en": "Isfiya", "he": "עוספיה"},
            {"en": "Yokneam Illit", "he": "יקנעם עילית"},
            {"en": "Harev Tzameret", "he": "הרב צמרת"},
            {"en": "Bnei Zion", "he": "בני ציון"},
            {"en": "Hefer Valley", "he": "עמק חפר"},
            {"en": "Sharon", "he": "שרון"},
            {"en": "Judean Hills", "he": "הרי יהודה"},
            {"en": "Golan Heights", "he": "רמת הגולן"},
            {"en": "Arava", "he": "הערבה"},
            {"en": "Dead Sea", "he": "ים המלח"},
            {"en": "Sea of Galilee", "he": "ים כנרת"},
            {"en": "Kinneret", "he": "כנרת"},
            {"en": "Jordan River", "he": "נהר הירדן"},
            {"en": "Mount Hermon", "he": "הר חרמון"},
            {"en": "Mount Tabor", "he": "הר תבור"},
            {"en": "Mount Gilboa", "he": "הר הגלבוע"},
            {"en": "Mount Meron", "he": "הר מירון"},
            {"en": "Mount of Olives", "he": "הר הזיתים"},
            {"en": "Mount Scopus", "he": "הר הצופים"},
            {"en": "Ben Sira", "he": "בן סירא"},
            {"en": "Ben Zvi", "he": "בן צבי"},
            {"en": "Ben Shemen", "he": "בן שמן"},
            {"en": "Ben Ammi", "he": "בן עמי"},
            {"en": "Ben Tzvi", "he": "בן צבי"},
            {"en": "Bar Giora", "he": "בר גיורא"},
            {"en": "Bar Ilan", "he": "בר אילן"},
            {"en": "Bar Lev", "he": "בר לב"},
            {"en": "Bar Yochai", "he": "בר יוחאי"},
            {"en": "HaShiva", "he": "השבעה"},
            {"en": "HaTishaa", "he": "התשעה"},
            {"en": "HaShisha", "he": "השישה"},
            {"en": "HaHamisha", "he": "החמישה"},
            {"en": "HaShalosh", "he": "השלוש"},
            {"en": "HaTishim", "he": "התשעים"},
            {"en": "HaSh Shim", "he": "השישים"},
            {"en": "HaChamishim", "he": "החמישים"},
            {"en": "Shabbat", "he": "שבת"},
            ...
            {"en": "Purim", "he": "פורים"},
            {"en": "Hanukka", "he": "חנוכה"},
            {"en": "Chanukah", "he": "חנוכה"},
            {"en": "Tisha B'Av", "he": "תשעה באב"},
            {"en": "Lag BaOmer", "he": "לג בעומר"},
            {"en": "Tu BiShvat", "he": "טו בשבט"},
            {"en": "Rosh Hashana", "he": "ראש השנה"},
            {"en": "Yom HaShoah", "he": "יום השואה"},
            {"en": "Yom HaZikaron", "he": "יום הזיכרון"},
            {"en": "Yom HaAtzmaut", "he": "יום העצמאות"},
            {"en": "Jerusalem Day", "he": "יום ירושלים"},
            {"en": "HaShoah", "he": "השואה"},
            {"en": "HaZikaron", "he": "הזיכרון"},
            {"en": "HaMa'apilim", "he": "המעפילים"},
            {"en": "HaShahid", "he": "השחיד"},
            {"en": "HaGush", "he": "הגוש"},
            {"en": "HaMa'avar", "he": "המעבר"},
            {"en": "HaMiflaga", "he": "המפלגה"},
            {"en": "HaMemshala", "he": "הממשלה"},
            {"en": "HaMoshava", "he": "המושבה"},
            {"en": "HaMedinah", "he": "המדינה"},
            {"en": "HaSharon", "he": "השרון"},
            {"en": "HaTechni", "he": "הטכני"},
            {"en": "HaUniversity", "he": "האוניברסיטה"},
            {"en": "HaYarkon Park", "he": "פארק הירקון"},
            {"en": "Yarkon Park", "he": "פארק הירקון"},
            {"en": "Rabin Square", "he": "כיכר רבין"},
            {"en": "Dizengoff Square", "he": "כיכר דיזנגוף"},
            {"en": "Zina Dizengoff Square", "he": "כיכר צינה דיזנגוף"},
            {"en": "Habima Square", "he": "כיכר הבימה"},
            {"en": "Magen David Square", "he": "כיכר מגן דוד"},
            {"en": "Tzina Square", "he": "כיכר צינה"},
            {"en": "Kikar Hamedina", "he": "כיכר המדינה"},
            {"en": "State Square", "he": "כיכר המדינה"},
            {"en": "Levinsky Park", "he": "פארק לבינסקי"},
            {"en": "Meir Park", "he": "פארק מאיר"},
            {"en": "Park Hayarkon", "he": "פארק הירקון"},
            {"en": "Charles Clore Park", "he": "פארק צ'רלס קלור"},
            {"en": "Ganei Yehoshua", "he": "גני יהושע"},
            {"en": "Park HaMesila", "he": "פארק המסילה"},
            {"en": "Sacher Park", "he": "פארק סאקר"},
            {"en": "Independence Park", "he": "גן העצמאות"},
            {"en": "Gan Meir", "he": "גן מאיר"},
            {"en": "Gan HaHashmal", "he": "גן החשמל"},
            {"en": "Sarona Market", "he": "שוק סרונה"},
            {"en": "Carmel Market", "he": "שוק הכרמל"},
            {"en": "Shuk HaCarmel", "he": "שוק הכרמל"},
            {"en": "Levinsky Market", "he": "שוק לבינסקי"},
            {"en": "Mahane Yehuda", "he": "מחנה יהודה"},
            {"en": "Old Jaffa", "he": "יפו העתיקה"},
            {"en": "Neve Tzedek", "he": "נווה צדק"},
            {"en": "Florentine", "he": "פלורנטין"},
            {"en": "Shapira", "he": "שפירא"},
            {"en": "Kerem HaTemanim", "he": "כרם התימנים"},
            {"en": "Kerem", "he": "כרם"},
            {"en": "Nachalat", "he": "נחלת"},
            {"en": "Yad Eliyahu", "he": "יד אליהו"},
            {"en": "Ezra", "he": "עזרא"},
            {"en": "Hatikva", "he": "התקווה"},
            {"en": "HaTikva Quarter", "he": "שכונת התקווה"},
            {"en": "Giv'at", "he": "גבעת"},
            {"en": "Givat Herzl", "he": "גבעת הרצל"},
            {"en": "Neve Sha'anan", "he": "נווה שאנן"},
            {"en": "Kiryat Shalom", "he": "קרית שלום"},
            {"en": "Ramat Aviv Gimmel", "he": "רמת אביב ג"},
            {"en": "Ramat Aviv Alef", "he": "רמת אביב א"},
            {"en": "Ramat Aviv Bet", "he": "רמת אביב ב"},
            {"en": "Tzahala", "he": "צהלה"},
            {"en": "Ramat Hahayal", "he": "רמת החייל"},
            {"en": "Bavli", "he": "בבלי"},
            {"en": "Shikun Dan", "he": "שיכון דן"},
            {"en": "Neve Avivim", "he": "נווה אביבים"},
            {"en": "Tel Baruch", "he": "תל ברוך"},
            {"en": "Yarkon", "he": "ירקון"},
            {"en": "HaYarkon", "he": "הירקון"},
            {"en": "Nachmani", "he": "נחמני"},
            {"en": "Montefiori", "he": "מונטיפיורי"},
            {"en": "Ahad Ha'am", "he": "אחד העם"},
            {"en": "Rothschild Boulevard", "he": "שדרות רוטשילד"},
            {"en": "Rothschild Blvd", "he": "שדרות רוטשילד"},
            {"en": "Chen Boulevard", "he": "שדרות חן"},
            {"en": "Chen Blvd", "he": "שדרות חן"},
            {"en": "Shaul HaMelech Boulevard", "he": "שדרות שאול המלך"},
            {"en": "Kaplan", "he": "קפלן"},
            {"en": "Hamasger", "he": "המסגר"},
            {"en": "Harakevet", "he": "הרכבת"},
            {"en": "Salame", "he": "סלמה"},
            {"en": "Menachem Usishkin", "he": "מנחם אוסישקין"},
            {"en": "Usishkin", "he": "אוסישקין"},
            {"en": "Hovevei Zion", "he": "חובבי ציון"},
            {"en": "Bnei Dan", "he": "בני דן"},
            {"en": "Derech Menachem Begin", "he": "דרך מנחם בגין"},
            {"en": "Derech Namir", "he": "דרך נמיר"},
            {"en": "Derech HaShalom", "he": "דרך השלום"},
            {"en": "Derech Petach Tikva", "he": "דרך פתח תקווה"},
            {"en": "Derech Kibbutz Galuyot", "he": "דרך קיבוץ גלויות"},
            {"en": "Kibbutz Galuyot", "he": "קיבוץ גלויות"},
            {"en": "La Guardia", "he": "לה גוארדיה"},
            {"en": "Yad Harutzim", "he": "יד הרוצים"},
            {"en": "Ibn Sina", "he": "אבן סינא"},
            {"en": "Ibn Rushd", "he": "אבן רושד"},
            {"en": "Ibn Ezra", "he": "אבן עזרא"},
            {"en": "Yehuda HaLevi", "he": "יהודה הלוי"},
            {"en": "Shlomo Ibn Gabirol", "he": "שלמה אבן גבירול"},
            {"en": "Shderot Yehudit", "he": "שדרות יהודית"},
            {"en": "Shderot Namir", "he": "שדרות נמיר"},
            {"en": "David Elazar", "he": "דוד אלעזר"},
            {"en": "Elazar", "he": "אלעזר"},
            {"en": "Haim Bar Lev", "he": "חיים בר לב"},
            {"en": "Raful", "he": "רפול"},
            {"en": "Dado", "he": "דדו"},
            {"en": "Motta Gur", "he": "מוטה גור"},
            {"en": "Gur", "he": "גור"},
            {"en": "Uzi Narkiss", "he": "עוזי נרקיס"},
            {"en": "Narkiss", "he": "נרקיס"},
            {"en": "Mordechai Gur", "he": "מרדכי גור"},
            {"en": "Yosef Trumpeldor", "he": "יוסף טרומפלדור"},
            {"en": "Meir Dizengoff", "he": "מאיר דיזנגוף"},
            {"en": "Pinhas Rosen", "he": "פנחס רוזן"},
            {"en": "Rosen", "he": "רוזן"},
            {"en": "Zalman Shazar", "he": "זלמן שז״ר"},
            {"en": "Ephraim Katzir", "he": "אפרים קציר"},
            {"en": "Katzir", "he": "קציר"},
            {"en": "Chaim Herzog", "he": "חיים הרצוג"},
            {"en": "Herzog", "he": "הרצוג"},
            {"en": "Ezer Weizman", "he": "עזר ויצמן"},
            {"en": "Moshe Katsav", "he": "משה קצב"},
            {"en": "Shimon Peres", "he": "שמעון פרס"},
            {"en": "Peres", "he": "פרס"},
            {"en": "Reuven Rivlin", "he": "ראובן ריבלין"},
            {"en": "Rivlin", "he": "ריבלין"},
            {"en": "Isaac Herzog", "he": "יצחק הרצוג"},
            {"en": "Bougie Herzog", "he": "בוז'י הרצוג"},
            {"en": "David Ben Gurion", "he": "דוד בן גוריון"},
            {"en": "Levi Eshkol", "he": "לוי אשכול"},
            {"en": "Golda Meir", "he": "גולדה מאיר"},
            {"en": "Yitzhak Rabin", "he": "יצחק רבין"},
            {"en": "Shimon Peres", "he": "שמעון פרס"},
            {"en": "Menachem Begin", "he": "מנחם בגין"},
            {"en": "Yitzhak Shamir", "he": "יצחק שמיר"},
            {"en": "Shamir", "he": "שמיר"},
            {"en": "Ehud Barak", "he": "אהוד ברק"},
            {"en": "Barak", "he": "ברק"},
            {"en": "Ariel Sharon", "he": "אריאל שרון"},
            {"en": "Arik Sharon", "he": "אריק שרון"},
            {"en": "Sharon", "he": "שרון"},
            {"en": "Ehud Olmert", "he": "אהוד אולמרט"},
            {"en": "Olmert", "he": "אולמרט"},
            {"en": "Benjamin Netanyahu", "he": "בנימין נתניהו"},
            {"en": "Netanyahu", "he": "נתניהו"},
            {"en": "Bibi", "he": "ביבי"},
            {"en": "Naftali Bennett", "he": "נפתלי בנט"},
            {"en": "Bennett", "he": "בנט"},
            {"en": "Yair Lapid", "he": "יאיר לפיד"},
            {"en": "Lapid", "he": "לפיד"},
            {"en": "Tommy Lapid", "he": "טומי לפיד"},
            {"en": "Haim Oron", "he": "חיים אורון"},
            {"en": "Oron", "he": "אורון"},
            {"en": "Amir Peretz", "he": "עמיר פרץ"},
            {"en": "Tzipi Livni", "he": "ציפי לבני"},
            {"en": "Livni", "he": "לבני"},
            {"en": "Avigdor Lieberman", "he": "אביגדור ליברמן"},
            {"en": "Lieberman", "he": "ליברמן"},
            {"en": "Aryeh Deri", "he": "אריה דרעי"},
            {"en": "Deri", "he": "דרעי"},
            {"en": "Moshe Ya'alon", "he": "משה יעלון"},
            {"en": "Yaalon", "he": "יעלון"},
            {"en": "Benny Gantz", "he": "בני גנץ"},
            {"en": "Gantz", "he": "גנץ"},
            {"en": "Gabi Ashkenazi", "he": "גבי אשכנזי"},
            {"en": "Ashkenazi", "he": "אשכנזי"},
            {"en": "HaTzanhanim", "he": "הצנחנים"},
            {"en": "HaGivati", "he": "הגבעתי"},
            {"en": "HaGolani", "he": "הגולני"},
            {"en": "Golani", "he": "גולני"},
            {"en": "HaNahal", "he": "הנחל"},
            {"en": "HaShayetet", "he": "השייטת"},
            {"en": "HaDuvdevan", "he": "הדובדבן"},
            {"en": "HaSayeret", "he": "הסיירת"},
            {"en": "Matkal", "he": "מטכ״ל"},
            {"en": "Sayeret Matkal", "he": "סיירת מטכ״ל"},
            {"en": "Shayetet 13", "he": "שייטת 13"},
            {"en": "Egoz", "he": "אגוז"},
            {"en": "Maglan", "he": "מגלן"},
            {"en": "Duvdevan", "he": "דובדבן"},
            {"en": "Yahalom", "he": "יהלום"},
            {"en": "Oketz", "he": "עוקץ"},
            {"en": "Shaldag", "he": "שלדג"},
            {"en": "669", "he": "669"},
            ...
            {"en": "Yamam", "he": "ימ״מ"},
            {"en": "Lotar", "he": "לוט״ר"},
            {"en": "HaIvrit", "he": "העברית"},
            {"en": "HaBrit", "he": "הברית"},
            {"en": "HaShalom", "he": "השלום"},
            {"en": "HaYetzira", "he": "היצירה"},
            {"en": "HaMada", "he": "המדע"},
            {"en": "HaTarbut", "he": "התרבות"},
            {"en": "HaOmanut", "he": "האמנות"},
            {"en": "HaSport", "he": "הספורט"},
            {"en": "HaBriut", "he": "הבריאות"},
            {"en": "HaChinuch", "he": "החינוך"},
            {"en": "HaMishpat", "he": "המשפט"},
            {"en": "HaKalkala", "he": "הכלכלה"},
            {"en": "HaMediniyut", "he": "המדיניות"},
            {"en": "HaDiplomatia", "he": "הדיפלומטיה"},
            {"en": "HaBitachon", "he": "הביטחון"},
            {"en": "HaTzava", "he": "הצבא"},
            {"en": "HaMishtara", "he": "המשטרה"},
            {"en": "HaKabaut", "he": "הכבאות"},
            {"en": "HaRefua", "he": "הרפואה"},
            {"en": "HaHandasa", "he": "ההנדסה"},
            {"en": "HaMishpatim", "he": "המשפטים"},
            {"en": "HaAgrikultura", "he": "החקלאות"},
            {"en": "HaHaklaut", "he": "החקלאות"},
            {"en": "HaDayagim", "he": "הדייגים"},
            {"en": "HaRo'im", "he": "הרועים"},
            {"en": "HaChaklai", "he": "החקלאי"},
            {"en": "HaTa'asiya", "he": "התעשייה"},
            {"en": "HaMis'har", "he": "המסחר"},
            {"en": "HaMelechet", "he": "המלאכה"},
            {"en": "HaTikshort", "he": "התקשורת"},
            {"en": "HaTipuach", "he": "התפוח"},
            {"en": "HaAgass", "he": "האגס"},
            {"en": "HaShezif", "he": "השזיף"},
            {"en": "HaDubdaban", "he": "הדובדבן"},
            {"en": "HaTapuach", "he": "התפוח"},
            {"en": "HaEshkol", "he": "האשכול"},
            {"en": "HaPardess", "he": "הפרדס"},
            {"en": "HaBustan", "he": "הבוסתן"},
            {"en": "HaSadeh", "he": "השדה"},
            {"en": "HaKfar", "he": "הכפר"},
            {"en": "HaYishuv", "he": "הישוב"},
            {"en": "HaMoledet", "he": "המולדת"},
            {"en": "HaMatmid", "he": "המתמיד"},
            {"en": "HaKore", "he": "הקורא"},
            {"en": "HaSofer", "he": "הסופר"},
            {"en": "HaMo're", "he": "המורה"},
            {"en": "HaTalmid", "he": "התלמיד"},
            {"en": "HaStudent", "he": "הסטודנט"},
            {"en": "HaMoreh", "he": "המורה"},
            {"en": "HaSefer", "he": "הספר"},
            {"en": "HaSifriya", "he": "הספרייה"},
            {"en": "HaMuseum", "he": "המוזיאון"},
            {"en": "HaTeatron", "he": "התיאטרון"},
            {"en": "HaKolno'a", "he": "הקולנוע"},
            {"en": "HaOpera", "he": "האופרה"},
            {"en": "HaSymphonia", "he": "הסימפוניה"},
            {"en": "HaBallet", "he": "הבלט"},
            {"en": "HaMachol", "he": "המחול"},
            {"en": "HaZemer", "he": "הזמר"},
            {"en": "HaNigun", "he": "הניגון"},
            {"en": "HaTzlil", "he": "הצליל"},
            {"en": "HaKol", "he": "הקול"},
            {"en": "HaTzeva", "he": "הצבע"},
            {"en": "HaTzura", "he": "הצורה"},
            {"en": "HaTmunat", "he": "התמונה"},
            {"en": "HaPatsal", "he": "הפסל"},
            {"en": "HaPisul", "he": "הפיסול"},
            {"en": "HaTziyur", "he": "הציור"},
            {"en": "HaTzalum", "he": "הצילום"},
            {"en": "HaArcheologia", "he": "הארכיאולוגיה"},
            {"en": "HaHistoria", "he": "ההיסטוריה"},
            {"en": "HaGeografia", "he": "הגאוגרפיה"},
            {"en": "HaSociologia", "he": "הסוציולוגיה"},
            {"en": "HaPsychologia", "he": "הפסיכולוגיה"},
            {"en": "HaPhilosophia", "he": "הפילוסופיה"},
            {"en": "HaDat", "he": "הדת"},
            {"en": "HaEmuna", "he": "האמונה"},
            {"en": "HaTefila", "he": "התפילה"},
            {"en": "HaBeit Knesset", "he": "בית כנסת"},
            {"en": "HaBeit Midrash", "he": "בית מדרש"},
            {"en": "HaYeshiva", "he": "הישיבה"},
            {"en": "HaUlpana", "he": "האולפנה"},
            {"en": "HaMidrasha", "he": "המדרשה"},
            {"en": "HaMachon", "he": "המכון"},
            {"en": "HaUniversita", "he": "האוניברסיטה"},
            {"en": "HaCollege", "he": "המכללה"},
            {"en": "HaTechnion", "he": "הטכניון"},
            {"en": "HaAcademia", "he": "האקדמיה"},
            {"en": "HaMachkar", "he": "המחקר"},
            {"en": "HaMadaan", "he": "המדען"},
            {"en": "HaProfessor", "he": "הפרופסור"},
            {"en": "HaDoctor", "he": "הדוקטור"},
            {"en": "HaRofe", "he": "הרופא"},
            {"en": "HaAchot", "he": "האחות"},
            {"en": "HaBait Cholim", "he": "בית חולים"},
            {"en": "HaMirpa'a", "he": "המרפאה"},
            {"en": "HaKupat Cholim", "he": "קופת חולים"},
            {"en": "HaBriut", "he": "הבריאות"},
            {"en": "HaRefua", "he": "הרפואה"},
            {"en": "HaTarof'a", "he": "התרופה"},
            {"en": "HaSam", "he": "הסם"},
            {"en": "HaChipus", "he": "החיפוס"},
            {"en": "HaChisun", "he": "החיסון"}
          ]
        }
        """.trimIndent()
    }
