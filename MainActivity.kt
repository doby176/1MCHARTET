...
class MainActivity : AppCompatActivity() {
    ...
    private fun getStreetsJSON(): String {
        // TOP 150 MOST COMMON ISRAELI STREETS - English → Hebrew Translation
        // Embedded directly in code - no external file needed!
        // Covers: Tel Aviv, Jerusalem, Haifa, Beer Sheva, major cities
        return """
        {
          "streets": [
            {"en": "Herzl", "he": "הרצל"},
            ...
            {"en": "Chana and Michael Levin", "he": "חנה ומיכאל לוין"},
            ...
            {"en": "Harav Berlin", "he": "הרב ברלין"},
            {"en": "Yehoshua Bin Nun", "he": "יהושע בן נון"},
            ...
            {"en": "Daniel", "he": "דניאל"},
            {"en": "Samuel", "he": "שמואל"},
            {"en": "Elijah HaNavi", "he": "אליהו הנביא"},
            {"en": "Balfour", "he": "בלפור"},
            {"en": "Bialik", "he": "ביאליק"},
            ...
            {"en": "Rachel", "he": "רחל"},
            {"en": "Reuven", "he": "ראובן"},
            {"en": "Raul Wallenberg", "he": "ראול ולנברג"},
            {"en": "Remez", "he": "רמז"},
            {"en": "Rishon LeZion", "he": "ראשון לציון"},
            {"en": "Shaul HaMelech", "he": "שאול המלך"},
            {"en": "Sderot HaNasi", "he": "שדרות הנשיא"},
            {"en": "Sderot Nordau", "he": "שדרות נורדאו"},
            {"en": "Shalom Aleichem", "he": "שלום עליכם"},
            {"en": "Shlomo HaMelech", "he": "שלמה המלך"},
            {"en": "Simeon", "he": "שמעון"},
            {"en": "Shmuel HaNavi", "he": "שמואל הנביא"},
            {"en": "Sderot Yerushalayim", "he": "שדרות ירושלים"},
            {"en": "Tuval", "he": "תובל"},
